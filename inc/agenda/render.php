...
function ss_agenda_render_session_card( $session ) {
	static $show_speaker_links = null;
	if ( null === $show_speaker_links ) {
		$show_speaker_links = ! empty( ss_get_agenda()['show_speaker_links'] );
	}
					...
					<?php foreach ( $session['participants'] as $p ) :
						...
						<div class="ss-agenda__participant">
							...
							<div class="ss-agenda__participant-info">
								...
								<?php endif; ?>
								<?php
								if ( $show_speaker_links && ( ! empty( $spk['linkedin_url'] ) || ! empty( $spk['website_url'] ) ) ) :
								?>
									<span class="ss-agenda__participant-links">
										<?php if ( ! empty( $spk['linkedin_url'] ) ) : ?>
											<a href="<?php echo esc_url( $spk['linkedin_url'] ); ?>" class="ss-agenda__participant-link" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( sprintf( __( '%s on LinkedIn', 'sender-symposium' ), $spk['name'] ) ); ?>">
												<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
											</a>
										<?php endif; ?>
										<?php if ( ! empty( $spk['website_url'] ) ) : ?>
											<a href="<?php echo esc_url( $spk['website_url'] ); ?>" class="ss-agenda__participant-link" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( sprintf( __( '%s website', 'sender-symposium' ), $spk['name'] ) ); ?>">
