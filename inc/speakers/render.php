...
function ss_render_speaker_card( $speaker, $display ) {
	...
	<article class="<?php echo esc_attr( $card_class ); ?>">
		...
		<div class="speaker-card__body">
			...
			<?php endif; ?>
			<?php if ( $display['show_linkedin'] && ! empty( $speaker['linkedin_url'] ) ) : ?>
				<a class="speaker-card__linkedin" href="<?php echo esc_url( $speaker['linkedin_url'] ); ?>" target="_blank" rel="noopener noreferrer">
